...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        wbvwMainBrowser = new MsWebView(page);
        wbvwMainBrowser->setObjectName(QStringLiteral("wbvwMainBrowser"));

        horizontalLayout_2->addWidget(wbvwMainBrowser);
